...
- [ ] **D-B1-8 场景样板：支脊山口 + 岩壁河谷（美术侧）**
    ...
    - **前置复核（2026-09-22）**：TB-01 与 RiverCliff（v1.52.6 / 生成器 14）已落地，可开始种子筛选；这不等于跨层遮挡或实机验收通过。默认仍为混合管线，先做遮挡冒烟，系统性失败转 TC-03/渲染缺陷；执行见 [TA-09 实施方案](TA-09-IMPLEMENTATION-PLAN.md)，本次仅修订计划，不勾选完成。
