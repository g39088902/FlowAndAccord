...
| TA-08 | ◐ 已重定向（2026-09-17，仅实测 + 验收矩阵） | 无跨实体遮挡拆分 | TA-07 的真值包围体与分级几何是 TA-08 遮挡实测的底座；★ 遮挡的**技术解**已改由全量 WebGL 深度缓冲承担（[31 号 §8](docs/plan/tech/31-canvas-to-webgl-migration.md)），原「跨实体深度拆分 / 子项化」策略取消，**不得**在 TA-07 内实施 |
