...
| `js/config.js` | ~215 | `window.SIM_CONFIG` 全局数值配置（238 字段，含拆分配置合计），按功能分区注释 | 前端配置文件是数值权威，Rust 负责接收契约 |
...
2. config.js                  SIM_CONFIG (238 字段，含拆分配置合计)
