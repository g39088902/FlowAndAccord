...
> **版本**：v1.50.15（版本演进记录见 [docs/current/11-changelog.md](./current/11-changelog.md)）
...
| — | 📜 版本演进记录 (Changelog) | [11-changelog.md](./current/11-changelog.md) | v0.9.24 ~ v1.49.1 各版本核心机制改动 |
