...
### 2.3 产物对生存循环的颠覆性加成
* **高能肉食**：每单位提供 1.5 倍于普通浆果的饱食度衰减抵抗期，大幅降低往返就餐频次。
* **御寒兽皮（Pelt）**：
  * 存入家户账本。在气温低于 `houseWinterColdTemp` (8℃) 的严寒冬夜，**每件兽皮抵消 50% 的烧柴消耗**；
  * 彻底缓解前期开荒家庭“缺木即冻死、伐木来不及”的恶性死局。
