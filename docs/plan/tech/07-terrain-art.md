...
| TB-02 | ✅ 已落地（v1.50.54，TB-02-01~10 全闭环）：台地聚落内核 profile（SDF 圆角矩形台面 + 陡壁过渡带 $B=0.6H$ + 双入口缓坡 $B=4.0H$ + 坡脚双泉溪 + 双接入路网 + 专属门禁 + 随机池准入，60 种子探针矩阵 100% 通过；交付 TA-10 表现层样板对接） | 旧 §9-2，详见 §7.4 | 高 | TB-01 |
