...
| 分级与剔除 | 远/中/近三档可辨且不混淆；缩放穿越阈值零闪烁；视口边缘无弹跳、无半株突现、**漏画 0 例**（TA-07 追加，见 §6.7 与 TA-07-TODO §6；★ 2026-09-22 起该项**不再作为独立验收补做任务**——TA-07 已取消视为完成，实现与静态/数值验证成果保留） |
