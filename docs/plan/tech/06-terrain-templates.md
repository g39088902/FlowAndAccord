...
| 9 | 河谷聚落 | 上游河道、谷底冲积带、两侧连续山坡 | 水、耕地、道路都沿谷底集中 | 新增 profile `river_valley_settlement_v1` | ✅ 内核骨架已交付（v1.50.48，S7-06：连续陡壁硬禁行 + 冲积谷底 + 台地缓穹，探针 60 种子 §1.4 门禁 0 违例，见 §4.3）；主河水系与浅滩走廊待 S7-07；`random` 候选待全链路验收 | §4.3 |
...
### 4.3 河谷聚落（`river_valley_settlement_v1`）· 设计登记（2026-09-13）· 内核骨架已交付（2026-09-13：v1.50.48 / S7-06）
