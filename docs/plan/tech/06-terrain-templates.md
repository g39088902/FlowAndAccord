...
| 15 | 平地草原 | 低幅起伏平原、草甸地表、孤立残丘与泉溪洼地（辅助至多二） | 无天然屏障的开放开局：选址与通行近乎自由，聚落结构完全由水源分布与踩踏涌现 | 新增 profile `grassland_plain_v1` | ✅ 内核骨架已交付（v1.50.40，S7-02；草甸装饰辨识度待 S7-03，`random` 候选待全链路验收） | §4.1 |
