...
| UGC-01 | ⬜ **新增规划**：Field IR、通用算子和 HeightfieldBackend；先迁移草原与山口 recipe | UGC-00 | 是 / 中 | 根目录统一生成器设计 §4~§6 |
| UGC-02 | ⬜ **新增规划**：汇流、侵蚀、沉积、水位和水体语义投影 | UGC-01 | 是 / 高 | 根目录统一生成器设计 §4.4、§5、§8 |
| UGC-03 | ⬜ **新增规划**：河谷、半坡、台地、盆地、冲积扇、火山湖全部改为 recipe | UGC-02 | 是 / 高 | 根目录统一生成器设计 §6、§8 |
