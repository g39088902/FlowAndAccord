...
| 阶段四 · D-C | 通用资源景观套件、几何遮罩避让、五类配方样板（Water/Wood/Berry/Stone/Gold）、标签布局引擎与聚合/双目标停靠兜底（S4-01~S4-08 全部收口交付，v1.50.46~53，专项 [STAGE-04-TODO](../../../STAGE-04-TODO.md)） | 无——通用阶段四闭环；特定地貌专属景观群（S4-X1~X4）随对应注入器逐项交付 |
...
| 四 · D-C | **✅ 通用部分已收口交付（v1.50.46~53）**：通用资源景观套件、几何遮罩避让、五类配方样板、标签布局引擎、聚合与双目标停靠兜底完成（S4-01~S4-08 全部完成，专项 [STAGE-04-TODO](../../../STAGE-04-TODO.md)）；特定地貌专属景观群逐项交付 | 一·D-B1 已就绪；特定地貌专属景观群另需对应注入器 | 否 / 低 | §19、阶段四 TODO |
...
| D-C：高级装饰 | 泉水景观群、资源区景观群、标注避让 | D-B1；特定景观群依赖相应注入器，不等待 R0/全部 D-B2 | 中期 M3 | ✅ 通用部分已收口交付（v1.50.46~53，S4-01~S4-08 全部完成，资源景观套件/遮罩避让/五类配方样板/标签布局/聚合与双目标兜底，专项 [STAGE-04-TODO](../../../STAGE-04-TODO.md)）；特定地貌专属景观群待对应注入器落地 |
