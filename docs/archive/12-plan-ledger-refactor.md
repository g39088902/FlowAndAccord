...
> ⚠️ 本文档为**账本重构计划**：M1~M4 已全部落地（v1.3.0），M5 为收尾/验收。当前已实现的账本代码结构见 [`crates/sim_core/src/spatial/ledger/AGENTS.md`](../../crates/sim_core/src/spatial/ledger/AGENTS.md) 与 [`../current/tech/20-ledger-and-polity.md`](../current/tech/20-ledger-and-polity.md)。
>
> **依据**：[../plan/design/10-roadmap.md](../plan/design/10-roadmap.md) §3.4「多级产权账本经济」
