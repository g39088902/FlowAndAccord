...
地形与画面表现的专项方向见 [地形美术与世界景观提升规划](./21-plan-terrain-art.md)及[新地形特征与地理玩法规划](./22-plan-terrain-features.md)：短期改善地表、道路和标注，中期先做山口聚落与静态两岸河谷；再逐步扩展湖畔盆地、台地、河口三角洲、海湾、峡湾、河谷、半岛、海岛、沙漠绿洲、山前冲积扇与喀斯特等未来地图模板。长期连接动态水文、生态与历史变化，并按性能证据评估渲染升级。两份规划分别负责视觉表现与地理规则，尚未实现或排期。
...
让地图拥有可以被记住的地方：分隔聚落的河、绕山必经的山口。地形同时改变画面轮廓、路线选择与聚落条件。**本文是地形种类、生成关系、通行、选址和水资源语义的规划权威**；21 负责材质/光照/素材/遮挡/缓存等视觉；土地适宜性由地形提供，农田产权/投资/产出归 17 农业规划。

#### 8.5.2 建议优先建设的八类基础地形

| 地形 | 主要玩法价值 | 建议阶段 |
| :--- | :--- | :--- |
| 丘陵 | 建房地点与绕行距离取舍 | T1 首批 |
...
详细形态、边界与前置契约以[22 专项规划的地图组合库](./22-plan-terrain-features.md#3-未来地图组合库)为准；本表只汇总路线图层面的分期，均为未排期方向。
...
| 台地聚落 | 平缓台面、台缘、坡脚水源、缓坡入口 | T3 以后；|
| 河谷聚落 | 谷底河道、冲积带、两侧山坡、跨谷连接 | T2 后扩展 |
| 盆地绿洲 / 沙漠绿洲 / 山前冲积扇 | 低地汇水或泉源、干旱/山前过渡地表与可建扇缘 | T3；先静态地表、通行和选址，动态洪水/地下水后置 |
