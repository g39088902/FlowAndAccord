...
地形与画面表现的专项方向见 [地形美术与世界景观提升规划](./21-plan-terrain-art.md)及[新地形特征与地理玩法规划](./22-plan-terrain-features.md)：短期改善地表、道路和标注，中期先做山口聚落与静态两岸河谷（v1.47.7 起不再规划台地/高台），再扩展湖泊湿地等组合；长期连接动态水文、生态与历史变化，并按性能证据评估渲染升级。两份规划分别负责视觉表现与地理规则，尚未实现或排期。
