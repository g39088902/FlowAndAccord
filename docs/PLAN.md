...
3. [系统架构与关键子系统设计](#3-系统架构与关键子系统设计)
   ...
   - 3.4 [多级产权账本经济（Property Ledger Economy - 资产负债表即社会结构）](#34-多级产权账本经济property-ledger-economy---资产负债表即社会结构)
   - 3.5 [生成式立绘社交、阶级微表情与心声日记（纯粹情感与道德羁绊，去功利数值化）](#35-生成式立绘社交阶级微表情与心声日记纯粹情感与道德羁绊去功利数值化)
   - 3.6 [LLM 认知层：希腊合唱队、议会大辩论与意识形态涌现](#36-llm-认知层希腊合唱队议会大辩论与意识形态涌现)
   - 3.7 [关键技术栈](#37-关键技术栈)
...
graph TB
    ...
    subgraph Core ["⚙️ 确定性模拟核心 (Headless Simulation Core - Rust 20Hz Tick)"]
        ...
        subgraph EconomySubsystem ["💰 专利、资本与微观经济"]
            ...
            PropertyLedger["五级产权账本体系 (§3.4)<br>Personal / Family / Clan / PublicStore / Corporate(预留)"]
            ExplicitSettlement["显式支付与收支流水结算<br>(资产负债表快照, 可审计)"]
        end
...
### 3.4 多级产权账本经济（Property Ledger Economy - 资产负债表即社会结构）

- **设计动机**：传统模拟中资产往往"锁死"在建筑与单位内部（粮囤在房、钱埋在屋），经济行为缺少归属主体，无法解释"谁付的钱、谁收的租、谁挨的饿"。本节确立**产权账本愿景**：把社会经济拆分为五级**有管理者的账本主体**，任何一笔资源流动都是主体间的显式交易（纳税、救济、工资、分红、彩礼、租金、工程款），可审计、可追溯。**账本即权力，资产负债表即社会结构快照。**

#### ① 五级产权账本层级（资产负债表的社会结构化）

| 账本层级 | 管理者 | 对应政治向度 | 组织载体 | 核心张力（对垒 ⇄ 合作） |
| :--- | :--- | :--- | :--- | :--- |
| **🧍 个人私产 Personal** | 居民本人（`PersonalWallet`，下台/迁徙不没收） | 个体自由 | 随身行囊 / 私库 | 私产不可侵犯 ⇄ 征税与征用 |
| **🏠 家产 Family** | **户主** | 宗法 Dynasty（微观） | 家庭 | 户主独断 ⇄ 家庭成员权益 |
| **⛩️ 族产 Clan** | **宗族长老会** | 宗法 Dynasty（宏观） | 宗族 | 长老礼法 ⇄ 族内新兴户主；族际竞争 ⇄ 联姻结盟 |
| **🏛️ 公仓 PublicStore** | **地区官员** | 民意 Civic + 国家能力（财税汲取） | 营地 / 行政区 | 灾年救济仁政 ⇄ 加税汲取与官员贪腐 |
| **🏢 公司资产 Corporate**（预留扩展位） | **老板**（雇佣劳动、复式记账、有限责任） | 资本 Capital | 商号 / 企业 | 劳资博弈、垄断 ⇄ 反垄断、入股合伙 |

#### ② 账本流转与势力博弈网络

```mermaid
flowchart TD
    subgraph LedgerHierarchy ["🏦 五级产权账本主体（资产负债表的社会结构）"]
        P["🧍 个人私产 Personal<br>管理者: 居民本人<br>(PersonalWallet, 下台不没收)"]
        F["🏠 家产 Family<br>管理者: 户主"]
        C["⛩️ 族产 Clan<br>管理者: 宗族长老会"]
        G["🏛️ 公仓 PublicStore<br>管理者: 地区官员"]
        B["🏢 公司资产 Corporate (预留)<br>管理者: 老板 (雇佣劳动+复式记账)"]
    end
    ...
    P -->|"劳动 / 入股"| B
    B -->|"工资 / 分红"| P
    F -->|"显式支付 (开工扣款、竣工付清)"| Build["🏗️ 建造与升级施工"]
    B -->|"天使轮注资"| Patent["📜 野生专利股权 (§3.3)"]

    F & C & G & B --> Audit["📊 资产负债表快照<br>(收支流水可审计)"]
```

- **对垒形态**：挤兑与囤积（主体间资金战）、制裁与断供（公仓对特定家庭停发救济）、族际竞争（宗族间争夺 POI 采集权）、国有化与征用（强权形态没收公司资产）、劳资停工（公司断工资、雇员断劳动）；
- **合作形态**：族产联姻（账本合并）、公仓采购与军需订单（官员-企业利益链）、公司入股（个人私产转化为股权分红）、宗族互助（灾年族库接济困难家庭）；
- **组织演化谱系**：**家族 → 宗族 → 商号/公司**——账本主体的兼并重组与组织升级是长期博弈的终局叙事，与 §2.4 跨时代契合表严格对应：农耕时代宗祠族产/坞堡粮帮 → 工业时代公司托拉斯/工会互助金 → 现代社区物业基金/财团 → 赛博时代 DAO 金库/算力信托。

#### ③ 三大愿景支柱

1. **资产负债表即社会结构快照**：资产归属于账本主体而非"散落世界"，翻阅任一主体（家庭/宗族/公仓/公司）的资产负债表，就能读出它的社会位置——贫富差距、宗族规模、官员汲取率、劳资比例一目了然；
2. **经济可解释性（显式支付替代隐形门槛）**：建筑的每一次升起与坍塌都能在账本上找到因果链——开工扣款、竣工付清、冬季烧柴逐笔记账、灾年救济逐笔发放；不再存在"仓满即免费升级"的魔法经济；
3. **势力对垒与合作（账本主体即经济势力载体）**：五级账本主体是玩家与 AI 势力的经济底盘——统治者的"多重胜选联盟"（§1.2）本质上是多个账本主体的满意度加权，收买宗族长老就是补贴族产，讨好选民就是加码公仓救济。

#### ④ 政体映射与理论框架

- **六维向度映射**：个人私产→个体自由底盘；家产/族产→宗法 Dynasty 的微观与宏观双层；公仓→民意 Civic 与国家能力（Besley & Persson 财税汲取能力，§1.2）；公司资产→资本 Capital 的组织化形态。**账本管理者群体即"多重胜选联盟"的经济实体化**——混合政体的六维向度提升，最终都要落到对某一级账本的充值/抽取/再分配操作上；
- **理论底座**：
  - **科斯产权理论（Coase, The Problem of Social Cost）**：产权界定先于市场交易——先确权到账本主体，主体间的转移定价（税收、租金、工资）才有博弈空间；
  - **韦伯家产制（Weber, Patrimonialism）**：从家产经济到领地国家再到科层制的组织演化谱系，正是"家产→族产→公仓"三级账本的历史原型；
  - **凡勃伦企业论（Veblen, The Theory of Business Enterprise）**：金钱制度（资本账本）与实业生产（劳动账本）的持续冲突，即劳资博弈的理论化表达；
  - **复式记账与财政国家史（"看得见的账本"）**：近代国家的崛起伴随财政记录的可审计化——公仓流水的透明度本身就是统治合法性的一部分。
- **与既有概念衔接**：§6 的 `PersonalWallet`（私产主体）、§3.1 的 `DualTreasury`（公私双库）、§3.3 的 `PatentRegistry`（专利股权主体）均为本账本体系的实例化——专利授权计费、天使轮注资、在野做空，都只是**主体间的 Transfer 流水**，写入对应账本的资产负债表。

### 3.5 生成式立绘社交、阶级微表情与心声日记（纯粹情感与道德羁绊，去功利数值化）
...
### 3.6 LLM 认知层：希腊合唱队、议会大辩论与意识形态涌现
...
- [ ] **前置依赖：多级产权账本体系（§3.4）**——先落成个人私产/家产/族产/公仓/公司五级账本主体与收支流水，专利授权计费、救济、工资、分红等一切主体间交易才有归属与可审计的资产负债表。
