...
- 长期方向与未落地里程碑见 [`../../plan/design/10-roadmap.md`](../../plan/design/10-roadmap.md)。
...
| # | 看点 | 玩家能观察到的 | 规则与实现 |
| :--- | :--- | :--- | :--- |
| 1 | 真·自主 AI | Inspector 里「他此刻最想要什么、为什么想要」；决策顺序可拖拽热重排 | [12 生命与社会规则](./12-life-and-society.md) · [31 决策引擎](../tech/31-decision-engine.md) |
| 2 | 路是自己踩出来的 | 荒野小径 → 紫金帝国大道，没人走的路衰减回荒野 | [11 世界与地图规则](./11-world-rules.md) · [40 地形与路网](../tech/40-terrain-and-network.md) |
| 3 | 一间仓库到一座大庄园 | 五级形态、瞬时升级、自然折旧、无主房麦穗 37% 拍卖 | [12 生命与社会规则](./12-life-and-society.md) · [33 房屋系统](../tech/33-housing-system.md) |
| 4 | 四季会咬掉柴火 | 240s 一年、-3~31℃、冬季账本烧柴、低温受孕红线 | [11 世界与地图规则](./11-world-rules.md) · [41 四季与气候](../tech/41-seasons-climate.md) |
| 5 | 生死、遗传与六维禀赋 | 四项生理指标；智/力/魅/消化/睡眠/寿限六项禀赋代际漂移 | [30 生命周期](../tech/30-agent-life-cycle.md) |
| 6 | 家户 → 宗族 → 王国 | 成婚合并账本、分家继承、族税互助、长子继承王位、夺位远征 | [13 经济与资源规则](./13-economy.md) · [20 账本与政体](../tech/20-ledger-and-polity.md) |
| 7 | 千年族谱时间轴 | Y 轴严格映射出生时刻，主干优先落位，已故胎儿亦入谱 | [14 观察与交互设计](./14-observation-ux.md) |
| 8 | 时光倒流与永久存档 | Tick 回滚、1x~1024x 快进、本地文件直写、双主题 | [15 快照与存档](../tech/15-snapshot-and-save.md) |

补充看点：**动态季节光照**（光位一年扫 360°，春东/夏南/秋西/冬北，快捷键 `L` 开关）、
**写意微缩沙盘地形**（T2 两岸河谷静态水系 + D-A 装饰系统）、**水系微观生态层**（游鱼与波光）、
**地图图鉴独立页 + 世界种子分享**（`?seed=<n>`）。实现见 [`51 季节光照`](../tech/51-seasonal-lighting.md)
与 [`52 水体渲染`](../tech/52-water-rendering.md)。
...
超参与配置入口见 [`13 配置系统`](../tech/13-config-system.md) 与 [`14 配置速查`](../tech/14-config-reference.md)。
