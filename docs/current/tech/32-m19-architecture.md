...
> **关联**：[决策引擎](./31-decision-engine.md)（机制与马斯洛层） · [核心系统状态机全景](./11-core-systems-fsm.md) · [决策局部规则](../../../crates/sim_core/src/spatial/decisions/AGENTS.md)
...
>
> **源码与落地版本**：v1.46.10。本文规定架构边界、实施范围与增强全景；[技术规格书](./32-m19-architecture.md) 是类型、分支映射、阶段时序和验收条件的详细权威定义。
>
...
相关入口：[决策现状](./31-decision-engine.md)、[核心 FSM](./11-core-systems-fsm.md)、[决策局部规则](../../../crates/sim_core/src/spatial/decisions/AGENTS.md)、[性能验证指南](./63-benchmarking.md)。
...
[规格 §8](./32-m19-architecture.md#8-验收矩阵) 为唯一详细验收清单。
...
>
> **源码与落地版本**：v1.46.10；范围与里程碑见[总体规划](./32-m19-architecture.md)。本文是类型、控制协议、分支映射、时序及验收的详细权威定义。
>
