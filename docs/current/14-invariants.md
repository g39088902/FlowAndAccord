...
| B11 | **生育住宅门槛（★ v1.28.0）**：养育后代由男性户主在 `B18RaiseChild` 自主发起，除妻子身体指标达标且**流产冷却（200s）与产后休养冷却（200s）均结束**外，**男方（户主）名下须有 ≥1 级私宅**（0 级仓库/无房不生育） | §4.8 | 旧「生育去房屋化」口径已废弃；条件只写在 B18 分支内，避免与 `execute_pending_childcare` 双写漂移 |
