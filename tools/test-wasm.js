...
(async () => {
  ...
  ex.world_create(0, 764.0, 777, 20, simConfig.countCamps);
  runSteps(600, 1 / 60);
  ...
  applyConfig(simConfig);
  ex.world_create(0, 764.0, 2026, 20, simConfig.countCamps);
  ...
  applyConfig(simConfig);
  ex.world_create(0, 764.0, SAVE_SEED, 20, simConfig.countCamps);
