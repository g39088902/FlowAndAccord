...
const OUT_MD = path.join(ROOT, 'docs', 'current', 'tech', '05-config-reference.md');

// ---------------------------------------------------------------------------
// 配置字段 → 影响模块映射 (v1.7.0 新增)
//   基于字段名前缀推断，特殊字段显式覆盖。用于 05-config-reference.md 的「影响模块」列。
//   改字段影响面时须同步更新此映射。
// ---------------------------------------------------------------------------
const IMPACT_OVERRIDES = {
  ...
  terrainGrasslandMoundAmpMax: 'geo/terrain.rs (S7-02 草原残丘幅度抽样上限)',
  terrainGrasslandMoundRatioMin: 'geo/terrain.rs (S7-02 草原残丘幅径比下限)',
  terrainGrasslandMoundRatioMax: 'geo/terrain.rs (S7-02 草原残丘幅径比上限)',
  terrainSpringDepressionDepthMin: 'geo/terrain.rs (S7-02/04 泉溪洼地深度下限)',
  terrainSpringDepressionDepthMax: 'geo/terrain.rs (S7-02/04 泉溪洼地深度上限)',
  terrainSpringDepressionRadiusMin: 'geo/terrain.rs (S7-02/04 泉溪洼地凹圈半径下限)',
  terrainSpringDepressionRadiusMax: 'geo/terrain.rs (S7-02/04 泉溪洼地凹圈半径上限)',
  terrainHillsideNoiseDamp: 'geo/terrain.rs (S7-04 半坡 fBm 噪声增益阻尼)',
  terrainHillsideAmpMin: 'geo/terrain.rs (S7-04 半坡主坡幅度抽样下限)',
  terrainHillsideAmpMax: 'geo/terrain.rs (S7-04 半坡主坡幅度抽样上限)',
  terrainHillsideLeeSlopeMin: 'geo/terrain.rs (S7-04 背风坡目标峰值坡度下限)',
  terrainHillsideLeeSlopeMax: 'geo/terrain.rs (S7-04 背风坡目标峰值坡度上限)',
  terrainHillsideWindSlopeMin: 'geo/terrain.rs (S7-04 迎风坡目标峰值坡度下限)',
  terrainHillsideWindSlopeMax: 'geo/terrain.rs (S7-04 迎风坡目标峰值坡度上限)',
  terrainHillsideCrestShiftMin: 'geo/terrain.rs (S7-04 脊线横移比例下限 ×world)',
  terrainHillsideCrestShiftMax: 'geo/terrain.rs (S7-04 脊线横移比例上限 ×world)',
  terrainValleyFloorBaseM: 'geo/terrain.rs (S7-06 谷底基准高程)',
  terrainValleyFloorHalfMin: 'geo/terrain.rs (S7-06 谷底半宽抽样下限；建造保护线)',
  terrainValleyFloorHalfMax: 'geo/terrain.rs (S7-06 谷底半宽抽样上限)',
  terrainValleyWallHeightMin: 'geo/terrain.rs (S7-06 陡壁总高差抽样下限)',
  terrainValleyWallHeightMax: 'geo/terrain.rs (S7-06 陡壁总高差抽样上限)',
  terrainValleyWallRatioMin: 'geo/terrain.rs (S7-06 陡壁幅宽比 H/W 下限)',
  terrainValleyWallRatioMax: 'geo/terrain.rs (S7-06 陡壁幅宽比 H/W 上限；峰值梯度窗)',
  terrainValleyMeanderAmpMin: 'geo/terrain.rs (S7-06 谷轴蜿蜒振幅下限)',
  terrainValleyMeanderAmpMax: 'geo/terrain.rs (S7-06 谷轴蜿蜒振幅上限)',
  terrainValleyMeanderWaves: 'geo/terrain.rs (S7-06 谷轴蜿蜒周期数；S7-07 兼主河波形)',
  terrainValleyTaperRatio: 'geo/terrain.rs (S7-06 陡壁/台地包络起始比例；谷口缓梁)',
  terrainValleyNoiseFloorK: 'geo/terrain.rs (S7-06 谷底 fBm 分区阻尼)',
  terrainValleyNoiseWallK: 'geo/terrain.rs (S7-06 陡壁 fBm 分区阻尼)',
  terrainValleyNoiseUplandK: 'geo/terrain.rs (S7-06 台地 fBm 分区阻尼)',
  terrainValleyRiverWidthMin: 'geo/terrain.rs (S7-07 主河河宽抽样下限)',
  terrainValleyRiverWidthMax: 'geo/terrain.rs (S7-07 主河河宽抽样上限)',
  terrainValleyRiverBankM: 'geo/hydrology.rs (S7-07 低滩禁建带半宽；建造保护线)',
  ...
  terrainFanGullyCountMax: 'geo/alluvial_fan.rs (TB-03 干浅沟数量上限)',
  terrainFanGullyDepthM: 'geo/alluvial_fan.rs (TB-03 干浅沟最大深度)',
  terrainFanGullyWidthM: 'geo/alluvial_fan.rs (TB-03 干浅沟横截面全宽)',
  terrainFanGullyMeanderAmpRad: 'geo/alluvial_fan.rs (TB-03 干浅沟角向蜿蜒幅度)',
  terrainBasinSemiAxisRatio: 'geo/basin.rs (TB-03 盆地半轴比例)',
  terrainBasinDepthM: 'geo/basin.rs (TB-03 盆深)',
  terrainBasinRimHeightM: 'geo/basin.rs (TB-03 外缘低脊高度)',
  terrainBasinExitWidthDeg: 'geo/basin.rs (TB-03 陆路出口角宽)',
  terrainBasinPoolRadiusMinM: 'geo/basin.rs (TB-03 中心泉池半径抽样下限)',
  terrainBasinPoolRadiusMaxM: 'geo/basin.rs (TB-03 中心泉池半径抽样上限)',
...
const IMPACT_PREFIX_RULES = [
  ...
  { prefix: 'agentSpawn', mod: 'ecology/ (始祖播撒) / agent.rs' },
  ...
  { prefix: 'poiInteraction', mod: 'ecology/ (POI 交互采收/卸货)' },
  { prefix: 'poiUnload', mod: 'ecology/ (回家卸货入账速率 §4.4)' },
  { prefix: 'poiSpawn', mod: 'ecology/ (POI 初始化播撒布局)' },
  { prefix: 'poiMinDistance', mod: 'ecology/ (POI 空间排斥间距 §4.7)' },

  { prefix: 'countTerrain', mod: 'ecology/ (路网过渡节点)' },
  { prefix: 'count', mod: 'ecology/ (POI 数量 §4.7)' },

  { prefix: 'regenBase', mod: 'ecology/ / world_tick.rs (POI 再生速率)' },
  { prefix: 'stockMax', mod: 'poi.rs / ecology/ (POI 储量上限)' },
  { prefix: 'market', mod: 'poi.rs / ecology/ / market.rs (外部市场与动态定价)' },

  { prefix: 'roadAstar', mod: 'graph.rs (A* 寻路权重)' },
  { prefix: 'roadConnect', mod: 'ecology/ (路网连接距离)' },
...
// ---------------------------------------------------------------------------
// 生成 docs/current/tech/05-config-reference.md
// ---------------------------------------------------------------------------
function generateReference(rs, js, errors) {
  ...
  const lines = [];
  // 文档编号取自输出文件名前缀（目录内顺序号），避免与本文件路径硬编码双份
  const refNo = (path.basename(OUT_MD).match(/^(\d+)/) || [])[1] || '';
  lines.push(`# ${refNo}. Flow & Accord · 仿真超参数速查表`);
  lines.push('');
  ...
  // 章节号由本生成器按出现顺序重排为 1..N：config.rs 注释里的编号仅供分区阅读，
  // 出现重号（历史遗留）时以本表为准，避免生成文档出现两个 `## 8.`
  let sectionNo = 0;
  for (const [section, fields] of sections) {
    sectionNo += 1;
    const title = section.replace(/^\s*\d+\s*[.。、)）]\s*/, '').trim();
