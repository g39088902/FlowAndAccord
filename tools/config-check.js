...
const IMPACT_OVERRIDES = {
  ...
  terrainFanGullyCountMax: 'geo/alluvial_fan.rs (TB-03 干浅沟数量上限；v1.50.68 改 3~4 掷)',
  terrainFanGullyDepthM: 'geo/alluvial_fan.rs (TB-03 干浅沟最大深度；v1.50.68 提升)',
  terrainFanGullyWidthM: 'geo/alluvial_fan.rs (TB-03 干浅沟横截面全宽)',
  terrainFanGullyMeanderAmpRad: 'geo/alluvial_fan.rs (TB-03 干浅沟角向蜿蜒幅度)',
  terrainFanTopBandRatio: 'geo/terrain.rs (v1.50.68 扇顶砾石带外缘 t=r/L)',
  terrainFanEdgeBandRatio: 'geo/terrain.rs (v1.50.68 扇缘沃土带内缘 t=r/L)',
  terrainFanTopFertilityScale: 'geo/terrain.rs (v1.50.68 扇顶带肥力折减系数)',
