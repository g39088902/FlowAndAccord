...
| [docs/01-current.md](./docs/01-current.md) | Full index of implemented features & module navigation |
...
| [docs/current/21-ui-page-overview.md](./docs/current/21-ui-page-overview.md) · [22-society-ledger-ui.md](./docs/current/22-society-ledger-ui.md) · [23-ui-dev-guide.md](./docs/current/23-ui-dev-guide.md) | UI page panorama · society-ledger UI implementation · frontend development guide |
| [docs/11-plan.md](./docs/11-plan.md) | Long-term project roadmap |
| [docs/06-config-reference.md](./docs/06-config-reference.md) | Quick reference for the 200 tunable hyper-parameters (auto-generated) |
