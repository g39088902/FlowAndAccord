...
项目文档除根目录 **AGENTS.md**（唯一保留在根目录的文档）外，**其余全部收录于 `docs/` 目录**：**以 `docs/CURRENT.md`（索引入口）+ `docs/current/` 分模块文档描述"现状"，`docs/PLAN.md` / `docs/ARCHITECTURE.md` 描述"愿景"**：
...
| `crates/sim_core/src/spatial/ledger/` | `crates/sim_core/src/spatial/ledger/AGENTS.md` | 独立经济账本子系统：账本内核、团体基类、婚姻登记簿、家户体系（家庭跟着男人走）、分家/继承预留 |
