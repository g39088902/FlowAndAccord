...
| **docs/current/20-tools-guide.md** | 仿真内核与工程工具箱操作指南：`tools/` 目录下全部 24 个工具（门禁/测试/性能/诊断/族谱/版本治理）速查手册 | 查阅 tools 工具箱功能、参数用法与标准工作流时 |
...
- 改 POI 数量须同步：`ecology/` → `index.html` 面板文案 → `docs/current/02-ecology-poi.md`。
